...
<Card className="bg-white/5 border border-green-500/30 hover:bg-white/10 hover:border-green-400/50 hover:scale-105 transition-all duration-300 hover:shadow-2xl hover:shadow-green-500/60 group relative overflow-hidden">
  ...
  <CardContent className="p-6 relative z-10">
    ...
    <div className="absolute top-4 right-4 z-30 flex items-center gap-3">
      <a
        href="https://your-live-demo.example.com" // live app
        target="_blank"
        rel="noopener noreferrer"
      ...
      <a
        href="https://github.com/youruser/query-analyzer" // repo
        target="_blank"
        rel="noopener noreferrer"
        className="hover:scale-110 transition-transform text-gray-400 hover:text-white"
    ...
    <h3 className="text-white font-bold text-xl mb-3">Query Analyzer</h3>
    ...
    <div className="flex flex-wrap gap-2">
      <span className="px-3 py-1 bg-green-500/20 text-green-300 text-xs rounded-full border border-green-500/30">React</span>
      <span className="px-3 py-1 bg-green-500/20 text-green-300 text-xs rounded-full border border-green-500/30">Azure</span>
      <span className="px-3 py-1 bg-green-500/20 text-green-300 text-xs rounded-full border border-green-500/30">OpenAI</span>
      <span className="px-3 py-1 bg-green-500/20 text-green-300 text-xs rounded-full border border-green-500/30">TypeScript</span>
    </div>
  </CardContent>
</Card>
